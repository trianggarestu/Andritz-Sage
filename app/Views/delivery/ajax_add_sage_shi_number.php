                    ...
                    <div class="box-body">
                        <?php if (is_array($sage_shi_number_tf)) : ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" id="tf_dn_number" name="tf_dn_number" placeholder="" value="" maxlength="120" />
                    ...
                    <div class="box-body">
                        <?php if (is_array($sage_shi_number_pm)) : ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" id="pjc_dn_number" name="pjc_dn_number" placeholder="" value="" maxlength="120" />
