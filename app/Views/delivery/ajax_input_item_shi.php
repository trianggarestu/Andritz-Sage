...
<div class='modal-header'>
    ...
    <h4 class='modal-title' id='myModalLabel'> Form Input Item Delivery Note by G/R </h4>
</div>
                    ...
                    <div class="box-body">
                        ...
                        <div class='form-group'>
                            <div class="col-sm-12" style="margin: 2px;">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm required" id="ponumber" name="ponumber" value="<?= $po_number ?>" maxlength="60" readonly />
                                </div>
                            </div>
                        </div>
                        <div class='form-group'>
                            <div class="col-sm-12" style="margin: 2px;">
                                <div class="col-sm-4" style="text-align: right;">
                                    <label for="so_qty">Original Qty</label>
                                </div>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm required number" id="so_qty" name="so_qty" value="<?= $so_qty ?>" maxlength="5" readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class='form-group'>
                            <div class="col-sm-12" style="margin: 2px;">
                                <div class="col-sm-4" style="text-align: right;">
                                    <label for="gr_qty">G/R Qty</label>
                                </div>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control input-sm required" id="gr_qty" name="gr_qty" value="<?= $gr_qty ?>" maxlength="5" readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class='form-group'>
                            <div class="col-sm-12" style="margin: 2px;">
                                <div class="col-sm-4" style="text-align: right;">
                                    <label for="l_shi_qty">D/N Qty(sum)</label>
                                </div>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control input-sm required" id="l_shi_qty" name="l_shi_qty" value="<?= $shi_qty ?>" maxlength="5" readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class='form-group'>
                            <div class="col-sm-12" style="margin: 2px;">
                                <div class="col-sm-4" style="text-align: right;">
                                    <label for="shi_qty">Qty <code> (input) </code> </label>
                                </div>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control input-sm required" min="0" max="<?= $shi_qty_outs ?>" id="shi_qty" name="shi_qty" value="<?= $shi_qty_outs ?>" maxlength="5" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                                Input Item Quantity D/N By Item G/R
