					...
					<div class="box box-primary">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input id="username" name="username" class="form-control input-sm" type="text" placeholder="Username" value="<?= old('username'); ?>" maxlength="50" autofocus style="text-transform: uppercase;"></input>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input id="email" name="email" class="form-control input-sm required" type="text" placeholder="E-mail" value="<?= old('email'); ?>" maxlength="50"></input>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Password">Re-type Password</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="col-sm-4">
										<img class="img-thumbnail img-preview" src="<?= base_url() ?>/img/kuser.png">
									</div>
