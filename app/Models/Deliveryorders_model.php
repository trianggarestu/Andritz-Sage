...
class Deliveryorders_model extends Model
{
    ...
    function get_gr_pending_to_dn()
    {
        ...
        b.CTDESC,b.PRJDESC,b.PONUMBERCUST,b.PODATECUST,b.NAMECUST," . 'b."CONTRACT"' . ",b.CTDESC,b.PROJECT,b.CRMNO,b.CRMREQDATE,
    ...
    function get_rcp_pending_by_rcpuniq($rcpuniq)
    {
        ...
        c.SHIUNIQ,c.DOCNUMBER,c.SHINUMBER,c.SHIDATE,c.CUSTRCPDATE,c.SHIQTY,c.SHIQTYOUTSTANDING,c.SHIUNIT,c.POCUSTSTATUS,c.DELIVERYSTATUS
        from webot_RECEIPTS a 
        left join webot_CSR b on b.CSRUNIQ=a.CSRUNIQ
        left join ICITEM it on it.ITEMNO=b.ITEMNO
		left join webot_SHIPMENTS c on c.RCPUNIQ=a.RCPUNIQ
        where ((a.POSTINGSTAT=1 and c.POSTINGSTAT IS NULL) or (a.POSTINGSTAT=1 and c.POSTINGSTAT=0) or (c.POSTINGSTAT=1 and c.OFFLINESTAT=1)) and a.POUNIQ='$rcpuniq' ");
